        ...
        <div className='projects-container'>
            ...
            <Modal show={showModal1} onHide={handleClose1} id='garden-helper-modal' dialogClassName='modal-90w'>
              ...
              <Modal.Body>
                ...
                <div className='about-project'>
                  <p>
                    This was a really fun project, as I built the frontend and the backend.
          ...
          <div className='img-container'>
            ...
            <Modal show={showModal2} onHide={handleClose2} id='damerow-modal' dialogClassName='modal-90w'>
              ...
              <Modal.Body>
                ...
                <div className='about-project'>
                  <p>While working at Theorem Agency, I was tasked with redesigning the homepage of this dealership.<br/> 
                    I worked with the inhouse UI/UX designer on what the new page would look like. 
                    I changed the hero image and created the 2 buttons the are on top of the image.<br/> 
                    I also redesigned the FAQ section to use an accordion when a user clicked on one of the questions. 
                    I also worked on an interactive gallery of images that would zoom in when a user hovered over them.<br/> 
                    There was CSS heavy work involved in all of the aspects we changed.
          ...
          <div className='img-container'>
            ...
            <Modal show={showModal3} onHide={handleClose3} id='mopop-modal' dialogClassName='modal-90w'>
              ...
              <Modal.Body>
                ...
                <div className='about-project'>
                  <p>This project for the MoPOP Board of Directors was created while working at Theorem Agency. 
          ...
          <div className='img-container'>
            ...
            <Modal show={showModal4} onHide={handleClose4} id='mopop-modal' dialogClassName='modal-90w'>
              <Modal.Header closeButton>
                <Modal.Title>TrailBlazers NBA Team News Items</Modal.Title>
              </Modal.Header>
              <Modal.Body>
                <Image className='modal-img' src={blazersfull} alt='Blazers pregame page' />
                <div className='about-project'>
                  <p>I am a native Portlander and I was thrilled to work on the Trailblazers page while at Theorem Agency.
                    The site uses a React frontend and redesigning the news feed portion of the Blazers website was the most interesting part.
                    I had to pull the data from an API that the blazers made available to us and display it on the page.
                    I used bootstrap cards and CSS flexbox to get the look the team wanted for their new news feed.
                    There were a lot of stakeholders involved and I loved the collaboration on various elements to make sure that everything we were doing would align with the brand and spirit of the team.<br/>
                    Go Blazers!
                  </p>
                </div>
              </Modal.Body>
          ...
          <div className='img-container'>
            ...
            <Modal show={showModal5} onHide={handleClose5} id='mopop-modal' dialogClassName='modal-90w'>
              ...
              <Modal.Body>
                ...
                <div className='about-project'>
                  <p>This was something that started out as a fun discussion amongst friends, who love pets as much as I do, but I mostly use this site for testing new CSS I find interesting.
          ...
          <div className='img-container'>
            ...
            <Modal show={showModal6} onHide={handleClose6} id='mopop-modal' dialogClassName='modal-90w'>
              ...
              <Modal.Body>
                ...
                <div className='about-project'>
                  <p>While working at Theorem Agency they had an employee portal that had been designed, but had almost no styling.
